...
namespace NZBStatus
{
    ...
    //{
    //    // ╓╖╘╛─│
    //    private const string LUC = "╓";
    //    private const string RUC = "╖";
    //    private const string LBC = "╘";
    //    private const string RbC = "╛";
    //    private const string HL = "─";
    //    private const string VL = "│";

    //    private IList<string> _list;
    //    public ModalWindow(IList<string> list)
    //    {
    //        _list = list;
    //    }
    ...
    //    {
    //        var widest = _list.Max(x => x.Length);
